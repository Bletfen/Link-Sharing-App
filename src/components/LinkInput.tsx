...
export default function LinkInput({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-[0.4rem]">
        <p className="text-[1.2rem] text-[#333] leading-[1.8rem]">Platform</p>
        <PlatformDropDown
      ...
      <div>
        <p className="text-[1.2rem] text-[#333] leading-[1.8rem]">Link</p>
        <div
          className={`py-[1.2rem] px-[1.6rem] flex items-center justify-between
          rounded-[0.8rem] border bg-white
          focus-within:shadow-[0_0_32px_0_rgba(99,60,255,0.25)]
        ...
        >
          ...
          {error && (
            <p className="text-end w-[14rem] text-[1.2rem] text-[#ff3939] leading-[1.8rem]">
              {error}
            </p>
          )}
        </div>
