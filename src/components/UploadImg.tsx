import UploadImgIcon from "../../public/images/icon-upload-image.svg";
import { updateImg } from "../features/authSlice";
import { useDispatch, useSelector } from "react-redux";
import type { RootState } from "../store";
export default function UploadImg() {
  const userAvatar = useSelector(
    (store: RootState) => store.authMode.currentUser?.avatar
  );
